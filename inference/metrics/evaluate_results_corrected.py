...
def eval_results(predict_file, cal_f1=True, split=None, subset=False, bad_samples=False, eval_hops=-1):
    ...
    if "webqsp" in predict_file:
        samples_to_eval_path = "/usr/scratch/smiao35/projects/LTRoG/scored_triples/webqsp_240912_unidir_test.pth"
        dataset_name = "webqsp"
    elif "cwq" in predict_file:
        samples_to_eval_path = "/usr/scratch/smiao35/projects/LTRoG/scored_triples/cwq_240907_unidir_test.pth"
        dataset_name = "cwq"
    else:
        raise NotImplementedError
    pred_file_path = f"/usr/scratch/smiao35/projects/LTRoG/results/KGQA/RoG-{dataset_name}/RoG/test/results_gen_rule_path_RoG-{dataset_name}_RoG_test_predictions_3_False_jsonl/predictions.jsonl"
